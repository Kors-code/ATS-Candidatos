...
use App\Models\Ciberi\Config;
use App\Models\Ciberi\Factura;
use App\Models\Ciberi\Invoice;
use App\Models\Ciberi\InvoiceLine;
use App\Models\Ciberi\Producto;
use App\Models\Ciberi\User;
use App\Models\Ciberi\ComprobanteSiigo;
   ...
   public function sendComprobanteSiigo(Request $request)
{
    ...
    DB::connection('mysql_ciberi')->beginTransaction();
    try {
        $config = Config::lockForUpdate()->first();
        if (!$config) {
            DB::connection('mysql_ciberi')->rollBack();
        ...
        DB::connection('mysql_ciberi')->commit();
